...
show_menu() {
    ...
    echo -e "\033[1;34m"
    echo "  _______     _                                                    __  __ __     __            _           _     "
    echo " |__   __|   | |                                      _     ____  |  \/  |\ \   / /           | |         | |    "
    echo "    | |  ___ | |  ___   __ _  _ __  __ _  _ __ ___   (_)   / __ \ | \  / | \ \_/ /___   _   _ | |_  _   _ | |__  "
    echo "    | | / _ \| | / _ \ / _` || '__|/ _` || '_ ` _ \       / / _` || |\/| |  \   // _ \ | | | || __|| | | || '_ \ "
    echo "    | ||  __/| ||  __/| (_| || |  | (_| || | | | | |  _  | | (_| || |  | |   | || (_) || |_| || |_ | |_| || |_) |"
    echo "    |_| \___||_| \___| \__, ||_|   \__,_||_| |_| |_| (_)  \ \__,_||_|  |_|   |_| \___/  \__,_| \__| \__,_||_.__/ "
    echo "                        __/ |                              \____/                                                "
    echo "                       |___/                                                                                     "
    echo -e "\033[0m"  # بازگشت به رنگ پیش‌فرض
